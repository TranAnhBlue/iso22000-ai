...
def seed_default_audits(db: Session = Depends(get_db)):
    ...
    if db.query(InternalAudit).count() == 0:
        aud1 = InternalAudit(
            ...
            auditor_team=[
                {"name": "Trần Thị Mai", "role": "Auditor", "dept": "QA/QC"},
                {"name": "Phạm Hùng Cường", "role": "Technical Expert", "dept": "Bảo Trì"},
            ],
        ...
        aud2 = InternalAudit(
            ...
            lead_auditor_name="Lê Hoàng Nam (QA Manager)",
            auditor_team=[{"name": "Trần Thị Mai", "role": "Auditor", "dept": "QA/QC"}],
        ...
        aud3 = InternalAudit(
            ...
            auditor_team=[{"name": "Lê Hoàng Nam", "role": "Lead", "dept": "QA/QC"}],
