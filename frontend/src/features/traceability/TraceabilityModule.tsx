...
import { PageHeader, AIBadge } from "@/components/common/PageHeader";
    ...
    <div className="space-y-6">
      ...
      {mode === "backward" && backwardTree && (
        <div className="space-y-6">
          ...
          {/* SƠ ĐỒ PHẢ HỆ CHUỖI CUNG ỨNG 4 TẦNG */}
          ...
          {/* DOCUMENT PREVIEW & PRINT TEMPLATE: BM-TX-01 */}
          <div
      ...
      {/* MODE B: FORWARD TRACEABILITY & MOCK RECALL */}
